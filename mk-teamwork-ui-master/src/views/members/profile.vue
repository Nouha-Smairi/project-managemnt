    ...
    <div class="members-profile">
        ...
        <div class="actions">
            <a-tabs :animated="false" defaultActiveKey="1" v-model="tabKey" @change="tabChange">
                <a-tab-pane class="info-content base-info" tab="Details" key="1">
                    ...
                    <a-row class="content-wrapper">
                        ...
                        <a-col :span="8">
                            <div class="info-item">
                                <span class="muted">cell phone</span>
                        ...
                        <a-col :span="8">
                            <div class="info-item">
                                <span class="muted">join time</span>
                                <span>{{member.create_time}}</span>
                            </div>
                        </a-col>
                    </a-row>
                </a-tab-pane>
                <!--<a-tab-pane class="info-content" tab="Recent news*" key="2" forceRender>
                    <p class="action-wrapper">
                        <span class="title">Recent developments</span>
                    </p>
                </a-tab-pane>-->
                <a-tab-pane class="info-content" tab="task arrangement" key="3">
                    <p class="action-wrapper">
                        <span class="title">
                            task arrangement
                             <a-dropdown :trigger="['click']">
                                    <a class="muted m-l-sm" style="font-size: 14px;">
                                        <span v-if="task.type[0] == 0">unfinished tasks </span>
                ...
                <a-tab-pane class="info-content" tab="Ta s project" key="4">
                    <p class="action-wrapper">
                        <span class="title">Ta's project</span>
                    </p>
                ...
                <a-row :gutter="24">
                    <a-col :span="12">
                        <a-form-item
                                label='Name'
                        >
                            <a-input placeholder='enter name' size="large"
                                     v-decorator="['name',{rules: [{ required: true, message: 'Please fill in your name' }], validateTrigger: 'blur'}]"
                            />
                        </a-form-item>
                    </a-col>
                    <a-col :span="12">
                        <a-form-item
                                label='Mail'
                        >
                            <a-input placeholder='Enter email address' size="large"
                                     v-decorator="['email',{rules: [{ required: true, message: 'Please fill in your email address' }], validateTrigger: 'blur'}]"
                            />
                        </a-form-item>
                    </a-col>
                    <a-col :span="12">
                        <a-form-item
                                label='cell phone'
                        >
                            <a-input placeholder='Enter phone' size="large"
                                     v-decorator="['mobile']"
                            />
                        </a-form-item>
                    </a-col>
                    <a-col :span="12">
                        <a-form-item
                                label='Position'
                        >
                            <a-input placeholder='Enter job title' size="large"
                ...
                <a-row :gutter="24">
                    <a-col :span="24">
                        <a-form-item
                                label='describe'
                        >
                            <a-input placeholder='enter description' size="large" type="textarea" :rows="3"
        ...
        data() {
            return {
                ...
                actionInfo: {
                    ...
                    modalTitle: 'Organization Member Information',
                }
            }
        },
        computed: {},
