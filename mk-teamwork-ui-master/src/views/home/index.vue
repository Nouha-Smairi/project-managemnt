        ...
        <div class="page-header">
            ...
            <div class="header-content">
                <div class="left-content">
                    ...
                    <div class="user-info">
                        <div class="title">{{helloTime}}{{ userInfo.name }}，Hope you will be happy every day!</div>
            ...
            <a-row :gutter="24">
                <a-col :xl="16" :lg="24" :md="24" :sm="24" :xs="24">
                    <a-card
                        ...
                        <router-link to="/project/list/my" slot="extra">all items</router-link>
                        <div>
                                    ...
                                    <a-card-meta>
                                        ...
                                        <div slot="description" class="card-description">
                                            ...
                                            <span class="description-text">
                                                ...
                                                <span v-else>No introduction yet</span>
                                            </span>
                                            </a-tooltip>
                                            <a-tooltip placement="right" :mouseEnterDelay="0.3"
                                                       :title="`Current progress:${item.schedule}%`">
                            ...
                            <p class="muted text-center m-t-md m-b-md" v-if="!projectList.length">No project yet</p>
                        </div>
                    </a-card>
                    <a-card class="activities-list" :loading="loading" title="dynamic"  :bordered="false">
                        <a-list>
                            <a-list-item :key="index" v-for="(item, index) in activities">
                                <a-list-item-meta>
                                    ...
                                    <div slot="title">
                                        ...
                                        <template v-if="item.is_comment == 1">commented
                ...
                <a-col
                    ...
                    <a-card class="tasks-list" style="margin-bottom: 24px"
                        ...
                        <div slot="title">
                            <div class="flex ant-row-flex-space-between ant-row-flex-middle">
                                <span>my task · {{task.total}}</span>
                                <a-select v-model="task.done" @select="taskSelectChange" :defaultActiveFirstOption="false">
                                    <a-select-option :key="0">undone</a-select-option>
                                    <a-select-option :key="1">completed</a-select-option>
                                </a-select>
                            </div>
                        </div>
                        <a-tabs defaultActiveKey="1" :animated="false" @change="taskTabChange">
                            <a-tab-pane key="1">
                                <span slot="tab"><a-icon type="bars" />I executed</span>
                            </a-tab-pane>
                            <a-tab-pane key="2">
                                <span slot="tab"><a-icon type="team" />I participated</span>
                            </a-tab-pane>
                            <a-tab-pane key="3">
                                <span slot="tab"><a-icon type="rocket" />I created</span>
                            </a-tab-pane>
                        </a-tabs>
                    ...
                    <a-card :loading="loading" :title="'team  · ' + accounts.total" :bordered="false">
                        <div class="members">
                            <a-row>
