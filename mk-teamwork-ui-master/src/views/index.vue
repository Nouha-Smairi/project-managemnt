                ...
                <a-layout-header :class="{'collapsed':collapsed}">
                    ...
                    <div class="right-menu">
                        <div class="m-r-lg" v-if="config.WS_URI">
                            <a-badge title="currently online" :count="online" showZero :numberStyle="{backgroundColor: '#52c41a'} " :offset="[10,0]">
                                <a-icon type="team"/>
                            </a-badge>
                        </div>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            //Extended syntax. For arrays and objects, it is to remove each item in the variable after the operator.
            //This thing can be used where the function is defined, such as using func(...args) to put the parameters passed in by the function into the args array.
            ...mapState({
        ...
        methods: {
            ...
            checkLayout() {
                //Update the selected state of the left menu
                let that = this;
                ...
                //Recursively find the top menu of the current route, then update the left menu
                if (meta.model) {
            ...
            menuClick(event, menu) {
                //Click on the left navigation to jump to the page
                let that = this;
                let openKeys = [];
            ...
            menuModelClick(event) {
                //Click on the top navigation to jump to the page
                let that = this;
