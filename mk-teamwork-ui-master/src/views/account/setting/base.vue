                    ...
                    <div class="setting-info">
                        <div class="setting-info-content">
                            <a-form
                                ...
                                <a-form-item
                                        label='Introduction'
                                >
                                    <a-textarea placeholder='Personal profile'
                                                :rows="4"
                                ...
                                <a-form-item
                                >
                                    <a-button type='primary' htmlType='submit' :loading="loading">update basic information</a-button>
                                </a-form-item>
                            </a-form>
                        </div>
                        <div class="setting-info-avatar">
                            ...
                            <a-upload
                                    ...
                                    @change="handleChange"
                            >
                                <a-button icon="upload" class="upload">change avatar</a-button>
                            </a-upload>
                        </div>
                    </div>
                </div>
