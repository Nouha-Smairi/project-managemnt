    ...
    <div class="project-template-index">
        <wrapper-content :showHeader="false">
            <a-tabs :animated="false" v-model="viewType">
                <a-tab-pane tab="custom template" key="0"></a-tab-pane>
                <a-tab-pane tab="public template" key="1"></a-tab-pane>
                <a-button type="primary" slot="tabBarExtraContent" icon="plus" @click="doAction(null,'new')">Make a project template
                </a-button>
            </a-tabs>
            <a-list
                    class="default-list"
            ...
            >
                <div v-if="showLoadingMore" slot="loadMore"
                    ...
                    <a-button v-else @click="onLoadMore">View more templates</a-button>
                </div>
                <a-list-item slot="renderItem" slot-scope="item,index">
                    <span slot="actions" v-if="!item.is_system" @click="doAction(item,'stages')">
                         <a-tooltip title="task list">
                              <a-icon type="bars"/>
                         </a-tooltip>
                    </span>
            ...
            >
                <div class="cover-item">
                    ...
                    <a-upload
                            ...
                            @change="handleChange"
                            >
                        <a-button icon="upload" class="upload">upload cover</a-button>
                        <span class="upload-tips muted">The best image ratio is 300*150</span>
                    </a-upload>
                </div>
                <a-form-item
                >
                    <a-input placeholder='Template name (required)'
                             v-decorator="[
                                            'name',
                ...
                <a-form-item
                >
                    <a-textarea placeholder='template description'
                                :rows="2"
                ...
                >
                    <div class="action-btn">
                        <a-button type="primary" htmlType='submit'
                                  ...
                                  class="middle-btn">save template
                        </a-button>
                    </div>
                </a-form-item>
            </a-form>
        ...
        methods: {
            ...
            doAction(record, action, index) {
                ...
                if (action == 'edit' || action == 'new') {
                    ...
                    this.$confirm({
                        ...
                        content: `Projects already created from the template ${this.currentTemplate.name}after deleting it will not be affected`,
            ...
            handleChange(info) {
                if (info.file.status === 'uploading') {
                    //notice(`Uploading, please wait...`, 'message', 'loading', 0);
