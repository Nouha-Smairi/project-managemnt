<template>
    <div class="project-template-index">
        <wrapper-content :showHeader="false">
            <div class="action">
                <a-button type="primary" icon="plus" @click="doAction(null,'new')">add task</a-button>
            </div>
            <h3>「{{$route.query.name}}」task list</h3>
            <a-list
                    class="default-list"
                    :loading="loading"
            ...
            >
                <div v-if="showLoadingMore" slot="loadMore"
                    ...
                    <a-button v-else @click="onLoadMore">View more tasks</a-button>
                </div>
        ...
        >
            ...
            >
                <a-form-item
                >
                    <a-input placeholder='Task name (required)'
                             v-decorator="[
                                            'name',
                ...
                <a-form-item
                        help="Sorting, the larger the value, the higher the front, the default is 0"
                >
                    <a-input-number style="width: 100%" :min="0" placeholder='to sort'
                             v-decorator="[
                                            'sort',
                                            ]"/>
                </a-form-item>
            ...
            doAction(record, action, index) {
                ...
                if (action == 'edit' || action == 'new') {
                    ...
                    this.$confirm({
                        ...
                        content: `Projects created with this task after deleting the task ${this.currentTemplate.name}will not be affected`,
                        okText: 'delete task',
                        okType: 'danger',
