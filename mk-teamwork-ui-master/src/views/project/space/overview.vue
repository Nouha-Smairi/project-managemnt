        ...
        <wrapper-content :showHeader="false">
            <div class="overview-item m-b">
                <div class="content-item">
                    <h3 class="m-sm m-b text-center">Task burndown chart</h3>
                                ...
                                <a-list-item :key="index" v-for="(item, index) in projectInfoList">
                                    <a-list-item-meta>
                                        <div slot="title">
                                            <a-tooltip :mouseEnterDelay="0.5">
                                                <template slot="title">
                                                    <span>{{item.description ? item.description : 'no description yet'}}</span>
                                                </template>
                                                <span>{{ item.name }} </span>
                                            </a-tooltip>
...
<!--                                        </span>-->
                        ...
                        <div class="list-content">
                            <a-list>
                                <div v-if="showLoadingMore" slot="loadMore"
                                    ...
                                    <a-button v-else @click="onLoadMore">View more news</a-button>
                                </div>
                    ...
                    <div class="content-item">
                        ...
                        <div class="project-date m-b-lg m-t-lg">
                            <div class="muted m-b-xs">
                                <a-tag color="green">Project Cycle</a-tag>
                            </div>
                            <a-range-picker
                                    v-model="projectDate"
                                    format="YYYY年MM月DD日"
                        ...
                        <div class="project-stats m-b-lg">
                            <div class="muted m-b-xs">
                                <a-tag color="green">Project statistics</a-tag>
                            </div>
                        ...
                        <div>
                            <div class="muted">
                                <a-tag color="green">New task trend</a-tag>
                            </div>
                            <ve-line
                                    :data="chartData"
        ...
        >
            ...
            >
                ...
                <a-form-item
                >
                    <a-textarea placeholder='content'
                                :rows="2"
                                v-decorator="['value']"
                    />
                </a-form-item>
        ...
        data() {
            return {
                ...
                burnoutMap: {
                    loading: true,
                    chartData: {
                        columns: ['date', 'Actual remaining tasks', 'ideal remaining tasks'],
                        rows: []
                    },
                    series: [
                        {
        ...
        methods: {
            ...
            getProjectLog(reset = true) {
                ...
                getLogBySelfProject(this.requestData).then(res => {
                    ...
                    res.data.list.forEach((item) => {
                        list.push(item);
                        //Only show completion activity for tasks
            ...
            overviewForProject() {
                dateTotalForProject({projectCode: this.code}).then(res => {
                    ...
                    res.data.forEach((v) => {
                        list.push({
                            'date': moment(v.date).format('M月D日'),
                            'Task': v.total,
                        })
                    });
            ...
            createInfo() {
                ...
                app.infoModal.modalTitle = 'add field';
            },
            editInfo(info) {
                let app = this;
                ...
                app.infoModal.modalStatus = true;
                setTimeout(function () {
                    app.infoModal.modalTitle = 'edit field';
            ...
            delInfo(info, index) {
                let app = this;
                app.$confirm({
                    title: 'Are you sure to delete the current field?',
                    okText: 'delete',
                    okType: 'danger',
