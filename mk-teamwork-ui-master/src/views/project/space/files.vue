        ...
        <wrapper-content :showHeader="false">
            <div class="content-wrapper">
                <div class="content-item log-list">
                    <div class="header">
                        <span class="title">my file</span>
                        <div class="header-actions">
                            <!--<a><a-icon type="upload"></a-icon> upload files</a>-->
                            <a-button id="upload-file" icon="up-circle" type="dashed">upload</a-button>
                        </div>
                    </div>
                    <div class="list-content">
                        ...
                        >
                            ...
                            <div v-if="showLoadingMore" slot="loadMore"
                                ...
                                <a-button v-else @click="onLoadMore">View more documents</a-button>
                            </div>
                        </a-list>
                    </div>
                </div>
            ...
            doFile(action, fileCode) {
                ...
                switch (actionKey) {
                    case 'delete':
                        this.$confirm({
                            title: 'move to trash',
                            content: `Are you sure you want to move this file to the trash?`,
                            ...
                            onOk() {
                                ...
                                notice({
                                    title: 'Successfully moved to Trash',
                                    msg: 'It can be viewed in menu - view recycle bin - file'
                                }, 'notice', 'success', 5);
