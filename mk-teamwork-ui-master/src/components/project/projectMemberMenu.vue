    ...
    <div class="member-menu project-member-menu">
        <a-spin :spinning="projectMemberLoading || taskMemberLoading">
            ...
            <div class="search-content">
                <a-input v-model="keyword" size="large" placeholder="search">
            ...
            <div class="member-list">
                <vue-scroll>
                    <div class="list-group" v-show="!keyword">
                        <span class="title muted">participant</span>
                        <a-list
                                class="list-content"
                    ...
                    <div class="list-group">
                        <span class="title muted">other members</span>
                        <div class="member-list-item ant-list-item" @click="addToInvite('all')">
                            <div class="ant-list-item-meta">
                                ...
                                <div class="ant-list-item-meta-content">
                                    <h4 class="ant-list-item-meta-title"><span>all project members</span></h4>
                                </div>
                            </div>
                        ...
                        <a-list
                                ...
                                :locale="{emptyText: (keyword && keyword.length > 1) ? 'The member is not in the list of project members' : ''}"
                        >
                            <a-list-item class="member-list-item"
                                         slot="renderItem"
                                         slot-scope="item"
            ...
            <div class="footer">
                <a-button type="primary" size="large" block @click="inviteTaskMember">Define</a-button>
            </div>
        </a-spin>
    </div>
</template>
    ...
    export default {
        ...
        data() {
            return {
                ...
                initAllMember: false, //Initially select "All project members"
            };
        },
        created() {
            this.init();
