            ...
            <div class="task-header" :class="{'disabled': task.deleted}">
                    <span class="head-title" v-if="!task.deleted">
                        <span v-if="task.parentTask">
                            <span class="muted">belongs to the task：</span>
                ...
                <span class="head-title muted" v-else>
                        <a-icon type="delete"/>&nbsp;
                        <span>The task is already in the recycle bin and cannot be modified</span>
                    </span>
                <span class="header-action text-right">
                                ...
                                <a-menu @click="doTask" class="field-right-menu"
                                    ...
                                    <a-menu-item key="move">
                                          <a-icon type="snippets"/>
                                            <span>Mobile Tasks *</span>
                                    </a-menu-item>
                                    <a-menu-item key="star">
                                           <a-icon type="star"></a-icon>
                                            <span v-if="task.stared">cancel favorite</span>
                                            <span v-else>favorite task</span>
                                    </a-menu-item>
                                    ...
                                    <a-menu-item key="private">
                                           <a-icon :type="task.private ? 'lock' : 'unlock'"/>
                                            ...
                                            <a class="menu-action text-primary">
                                                <span v-if="task.private">Turned on</span>
                                                <span v-else>closed</span>
                                            </a>
                                            <div class="menu-desc muted">
                                                <span v-if="task.private">Only visible to participants</span>
                                                <span v-else>Visible to all members</span>
                                            </div>
                                    </a-menu-item>
                                </a-menu>
                        </a-dropdown>
                        ...
                        <template v-else>
                            <a class="action-item muted" @click="recoveryTask">
                                <a-icon type="undo"/> <span>restore content</span>
                            </a>
                            <a class="action-item muted" @click="deleteTask">
                                <a-icon type="delete"/> <span>Remove completely</span>
                            </a>
                        </template>
                         <a-tooltip :mouseEnterDelay="0.5">
                            <template slot="title">
            ...
            <div class="task-wrap">
                <div class="task-content">
                                ...
                                <div class="field-list" :class="{'disabled': task.deleted}">
                                    <div class="component-mount">
                                        <div class="field">
                                            <div class="field-left">
                                                ...
                                                <span class="field-name">finished condition</span>
                                            </div>
                                            <div class="field-right">
                                                <a-dropdown :trigger="['click']"
                                                    ...
                                                    <a-tooltip placement="top">
                                                        ...
                                                        <span>
                                                        <!--<a-icon type="check-square"/>-->
                                                        <a-tag v-if="task.done" color="green">completed</a-tag>
                                                        <span v-show="!task.done">undone</span>
                                                    </span>
                                                    </a-tooltip>
                                    ...
                                    <div class="component-mount">
                                        <div class="field">
                                            <div class="field-left">
                                                ...
                                                <span class="field-name">execution status</span>
                                            </div>
                                            <div class="field-right">
                                                <a-dropdown :trigger="['click']"
                                                            :disabled="!!task.deleted || !!task.hasUnDone"
                                    ...
                                    <div class="component-mount">
                                        <div class="field">
                                            <div class="field-left">
                                                <a-icon type="user"/>
                                                <span class="field-name">Executor</span>
                                            </div>
                                            <div class="field-right">
                                                <a-dropdown
                                                        :trigger="['click']"
                                                ...
                                                >
                                                    <a-tooltip :mouseEnterDelay="0.5" v-if="!task.deleted">
                                                        <template slot="title">
                                                            <span>Click on Set Executor</span>
                                                        </template>
                                                        <div class="field-flex">
                                                            ...
                                                            <template v-if="!task.executor">
                                                                ...
                                                                <a class="muted name">pending claim</a>
                                                            </template>
                                                        </div>
                                                    </a-tooltip>
                                            ...
                                            <div class="field-right field-date">
                                                <template v-if="task.openBeginTime">
                                                    <a-dropdown :trigger="['click']" v-model="showBeginTime"
                                                        ...
                                                        <a-tooltip :mouseEnterDelay="0.5" v-if="!task.deleted">
                                                            <template slot="title">
                                                                <span>Click to set start time</span>
                                                            </template>
                                                            <div class="field-flex">
                                                                <a class="muted name" style="margin: 0">
                                                                    <template v-if="!task.setBeginTime">set start time
                                                                    </template>
                                                        ...
                                                        <div class="field-flex" v-else>
                                                            <a class="muted name" style="margin: 0">
                                                                <template v-if="!task.setBeginTime">set start time</template>
                                                            ...
                                                            >
                                                                <template slot="renderExtraFooter">
                                                                    <a style="position: absolute;" size="small"
                                                                       @click="doBeginTime(false)">to clear</a>
                                                                </template>
                                                            </a-date-picker>
                                                        </div>
                                                    </a-dropdown>
                                                ...
                                                <a-dropdown :trigger="['click']" v-model="showEndTime"
                                                    ...
                                                    <a-tooltip :mouseEnterDelay="0.5" v-if="!task.deleted">
                                                        <template slot="title">
                                                            <span>Click to set deadline</span>
                                                        </template>
                                                        <div class="field-flex">
                                                            <a class="muted name" style="margin: 0">
                                                                <template v-if="!task.setEndTime">set deadline</template>
                                                    ...
                                                    <div slot="overlay">
                                                        ...
                                                        >
                                                            <template slot="renderExtraFooter">
                                                                <a style="position: absolute;" size="small"
                                                                   @click="doEndTime(false)">to clear</a>
                                                            </template>
                                                        </a-date-picker>
                                                    </div>
                                                </a-dropdown>
                                    ...
                                    <div class="component-mount">
                                        <div class="field">
                                            <div class="field-left">
                                                ...
                                                <span class="field-name">Remark</span>
                                            </div>
                                            <div class="field-right width-block">
                                                <div class="task-description" :class="{'disabled': task.deleted}"
                                                    ...
                                                    <span v-show="!task.description">Add notes</span>
                                                </div>
                                                <div class="m-t-sm" v-if="hasMoreDesc">
                                                    <a v-show="!showMoreDesc"
                                                       @click="checkShowMoreDesc(true)">display more</a>
                                                    <a v-show="showMoreDesc"
                                                       @click="checkShowMoreDesc(false)">Collapse notes</a>
                                                </div>
                                            ...
                                            <div class="field-right">
                                                ...
                                                <span>
                                                    ...
                                                    <a-menu class="field-right-menu" slot="overlay" @click="doPri"
                                                        ...
                                                        <a-menu-item :key="0">
                                                            <div class="menu-item-content">
                                                                <a-tag :color="priColor(0)">ordinary</a-tag>
                                                                <a-icon type="check" class="check muted"
                                                        ...
                                                        <a-menu-item :key="1">
                                                            <div class="menu-item-content">
                                                                <a-tag :color="priColor(1)">urgent</a-tag>
                                                                <a-icon type="check" class="check muted"
                                                        ...
                                                        <a-menu-item :key="2">
                                                            <div class="menu-item-content">
                                                                <a-tag :color="priColor(2)">very urgent</a-tag>
                                                                <a-icon type="check" class="check muted"
                                    ...
                                    <div class="component-mount">
                                        <div class="field">
                                            <div class="field-left">
                                                <a-icon type="bars"/>
                                                <span class="field-name">Subtasks <span v-show="childTaskList.length"> · {{childTaskDoneNum}}/{{childTaskList.length}}</span></span>
                                            </div>
                                            <div class="field-right width-block">
                                            </div>
                                        </div>
                                        ...
                                        <div class="field">
                                            <div class="block-field width-block">
                                                <div class="task-child">
                                                                    ...
                                                                    <a-tooltip placement="top">
                                                                        <template slot="title">
                                                                            <span v-if="childTask.parentDone"
                                                                                  style="font-size: 12px;">Parent task is complete, child task cannot be redone</span>
                                                                            <span v-else-if="childTask.hasUnDone"
                                                                                  style="font-size: 12px;">The subtasks have not all been completed and the parent task cannot be completed</span>
                                                                        </template>
                                                                    ...
                                                                    >
                                                                        <a-tooltip :mouseEnterDelay="0.5">
                                                                            <template slot="title">
                                                                                ...
                                                                                <span v-else>pending claim</span>
                                                                            </template>
                                                                            <a-avatar
                                                    ...
                                                    <div class="task-list" v-show="showChildTask">
                                                        <div class="add-task">
                                                            ...
                                                            <div class="action-btn text-right">
                                                                <a type="text" class="cancel-text muted"
                                                                   @click="showChildTask = false">Cancel</a>
                                                                <a-button type="primary" htmlType='submit'
                                                                          class="middle-btn"
                                                                          @click="createTask">save
                                                                </a-button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <a-tooltip placement="top">
                                                        <template slot="title">
                                                            <span v-if="task.done" style="font-size: 12px;">Parent task is completed, cannot add new subtasks</span>
                                                        </template>
                                                        <a class="add-handler"
                                    ...
                                    <div class="component-mount">
                                        <div class="field">
                                            <div class="field-left" style="width: 100%">
                                                ...
                                                <span class="field-name">working hours
                                                    <span v-if="workTimeList.length"> ·Actual working hours {{workTimeTotal}} hours, time record {{workTimeList.length}} bar, estimated hours {{task.work_time}} Hour   <a
                                                            class="muted m-l-sm" @click="doPlainWorkTime">
                                                                    <a-icon class="task-item" type="edit"/>
                                                                </a>
                                                    </span>
                                                    <span v-else>
                                                         <span v-if="task.work_time"> · Estimated hours {{task.work_time}} Hour</span>
                                                         <a-tooltip>
                                                            <template slot="title">
                                                            ...
                                                            <div class="list-item task m-l-xs">
                                                                <div class="task-item task-title hover-none">
                                                                    ...
                                                                    >
                                                                        ...
                                                                        {{moment(workTime.begin_time).format('MM月DD日 HH:mm')}}Start working hours at
                                                                        {{workTime.num}} Hour
                                                                        <div class="muted"
                                    ...
                                    <div class="component-mount">
                                        <div class="field">
                                            <div class="field-left">
                                                ...
                                                <span class="field-name">associated file</span>
                                            </div>
                                            <div class="field-right width-block">
                                            </div>
                                        </div>
                                    ...
                                    <div class="component-mount" v-show="taskSourceList.length > 0">
                                        <div class="field">
                                            <div class="block-field width-block">
                                                <div class="file-list">
                                                    <div class="m-xs m-t-none">associated files</div>
                                                    <a-list>
                    ...
                    <div class="content-right">
                        <div class="header">
                            <div class="title">
                                participant · {{taskMemberList.length}}
                            </div>
                            <div class="member-list">
                                ...
                                >
                                    <template slot="title">
                                        <span>{{member.name}} <span v-if="member.is_owner"> · creator</span></span>
                                    </template>
                                    <a-avatar
                                            class="member-item"
                                            icon="user"
                                ...
                                <a-dropdown :trigger="['click']" placement="bottomCenter"
                                    ...
                                    <a-tooltip :mouseEnterDelay="0.5">
                                        <template slot="title">
                                            <span>Click to add participants</span>
                                        </template>
                                ...
                                <div class="log-list muted">
                                    <a class="show-more muted" v-show="checkShowMoreLog"
                                       @click="getMoreTaskLog">
                                        ...
                                        show earlier {{taskLogTotal - taskLogList.length}} News
                                    </a>
...
<!--                                <span slot="title">Title</span>-->
                                <a-textarea @focus="commenting = true" @blur="commenting = false" ref="commentText" v-model="comment" :rows="1" placeholder="Support @mentions task members，Ctrl+Enter Comment"
                                            style="margin-right: 24px;"/>
                            </a-popover>
                            <a-button class="middle-btn" type="primary" @click="createComment">Comment</a-button>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <a-col :span="12">
                        ...
                        >
                            <a-date-picker
                                    ...
                                    v-decorator="[
                                'begin_time',
                                {rules: [{ required: true, message: 'Please select a date' }], validateTrigger: 'change',initialValue: moment()}
                            ]"
                            >
                            </a-date-picker>
                        </a-form-item>
                    ...
                    <a-col :span="12">
                        ...
                        >
                            <a-input
                                    ...
                                    v-decorator="[
                                'num',
                                {rules: [{ required: true, message: 'Please enter the elapsed time' }], validateTrigger: 'change'}
                            ]"
                            >
                            </a-input>
                        </a-form-item>
            ...
            <a-form
                ...
                >
                    <a-input
                            ...
                            v-decorator="[
                                'work_time',
                                {rules: [{ required: true, message: 'Please enter estimated hours' }], validateTrigger: 'change'}
                            ]"
                    >
                    </a-input>
                </a-form-item>
        ...
        watch: {
            ...
            uploader: {
                handler(newVal, oldVal) {
                    //Monitor whether there is an upload file behavior
        ...
        methods: {
            ...
            doTask(action) {
                ...
                switch (actionKey) {
                    case 'recycle':
                        this.$confirm({
                            title: 'move to trash',
                            content: `Are you sure you want to move this task to the trash?`,
                            okText: 'Sure',
                            okType: 'danger',
            ...
            doSource(action, source) {
                ...
                switch (actionKey) {
                    case 'unlink':
                        this.$confirm({
                            title: 'disassociate',
                            content: `Are you sure you want to permanently delete this association?`,
                            okText: 'Sure',
                            okType: 'danger',
                            cancelText: `Think again`,
                            onOk() {
                    ...
                    case 'copy':
                        notice({
                            title: 'Copy the link successfully',
                            msg: 'Paste in the address bar and open to download the resource'
                        }, 'notice', 'success', 5);
                        return true;
                }
            },
            deleteTask() {
                ...
                this.$confirm({
                    ...
                    content: `When a task is completely deleted, the task and its subtasks will be permanently deleted.`,
                    okText: 'delete',
                    okType: 'danger',
                    cancelText: `Think again`,
                    onOk() {
            ...
            recoveryTask() {
                ...
                this.$confirm({
                    ...
                    content: `Are you sure you want to resume this task?`,
                    okText: 'Sure',
                    okType: 'primary',
                    cancelText: `Think again`,
                    onOk() {
            ...
            copyLink() {
                notice({
                    title: 'Copy the link successfully',
                    msg: 'You can paste in other tabs and quickly open the task page'
                }, 'notice', 'success', 5);
            },
            like(like) {
                like = Number(like);
            ...
            deleteWorkTime(workTime, index) {
                let app = this;
                this.$confirm({
                    title: 'Delete time records',
                    content: `Are you sure you want to delete the time record?`,
                    okText: 'Sure',
                    okType: 'danger',
                    cancelText: 'Think again',
                    onOk() {
