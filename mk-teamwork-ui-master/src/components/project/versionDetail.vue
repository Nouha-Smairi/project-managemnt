<template>
    <div class="version-detail">
                                ...
                                <div class="field-list" :class="{'disabled': disableEdit}">
                                                    ...
                                                    <a-tooltip placement="top">
                                                        <template slot="title">
                                                            <span v-if="disableEdit"
                                                                  style="font-size: 12px;">Version is published and cannot be edited</span>
                                                        </template>
                                                        <span>
                                                    ...
                                                    <a-tooltip :mouseEnterDelay="0.5" v-if="!disableEdit">
                                                        ...
                                                        <div class="field-flex">
                                                            <a class="muted name" style="margin: 0">
                                                                <template v-if="!version.setStartTime">set start time</template>
                                                        ...
                                                        >
                                                            <template slot="renderExtraFooter">
                                                                <a style="position: absolute;" size="small"
                                                                   @click="doStartTime(false)">to clear</a>
                                                            </template>
                                                        </a-date-picker>
                                                    </div>
                                                </a-dropdown>
                                    ...
                                    <div class="component-mount">
                                        <div class="field">
                                            <div class="field-left">
                                                <a-icon type="calendar"/>
                                                <span class="field-name">release time</span>
                                            </div>
                                            <div class="field-right field-date">
                                                <a-dropdown :trigger="['click']" v-model="showPlanPublishTime"
                                                    ...
                                                    <a-tooltip :mouseEnterDelay="0.5" v-if="!disableEdit">
                                                        <template slot="title">
                                                            <span>Click to set release time</span>
                                                        </template>
                                                        <div class="field-flex">
                                                            <a class="muted name" style="margin: 0">
                                                                <template v-if="!version.setPlanPublishTime">set posting time
                                                                </template>
                                                    ...
                                                    <div slot="overlay">
                                                        ...
                                                        >
                                                            <template slot="renderExtraFooter">
                                                                <a style="position: absolute;" size="small"
                                                                   @click="doPlanPublishTime(false)">to clear</a>
                                                            </template>
                                                        </a-date-picker>
                                                    </div>
                                                </a-dropdown>
                                    ...
                                    <div class="component-mount">
                                        <div class="field">
                                            <div class="field-left">
                                                <a-icon type="fire"/>
                                                <span class="field-name">Complete schedule</span>
                                            </div>
                                            <div class="field-right width-block">
                                                <a-tooltip placement="top"
                                                           :mouseEnterDelay="0.3"
                                                           :title="`The system automatically counts the completion progress of the current version`">
                                        ...
                                        <div class="field">
                                            ...
                                            <div class="field-right width-block">
                                                <div class="task-description" :class="{'disabled': disableEdit}"
                                                    ...
                                                    <span v-show="!version.description">Add notes</span>
                                                </div>
                                    ...
                                    <div class="component-mount">
                                        <div class="field">
                                            <div class="field-left">
                                                <a-icon type="bars"/>
                                                <span class="field-name">Publish content <span v-show="versionTaskSchedule !== false"> · {{versionTaskDoneNum}}/{{versionTaskList.length}}</span></span>
                                            </div>
                                            <div class="field-right width-block">
                                            </div>
                                        </div>
                                                        ...
                                                        <div v-for="(versionTask, index) in versionTaskList"
                                                            ...
                                                            <div class="list-item task">
                                                                ...
                                                                <span class="m-r muted">
                                                                    <span v-if="versionTask.done" class="text-success">completed</span>
                                ...
                                <div class="log-list muted">
                                    <a class="show-more muted" v-show="checkShowMoreLog"
                                       @click="getMoreVersionLog">
                                        ...
                                        show earlier{{versionLogTotal - versionLog.length}} News
                                    </a>
                                    <div class="list-item"
        ...
        >
            <div>
                <p v-show="publishTask.selectTaskList.length">chosen <span class="text-warning">{{publishTask.selectTaskList.length}}</span>
                    item</p>
                <p class="muted" v-show="!publishTask.selectTaskList.length">Please tick the content that needs to be published</p>
            </div>
            <vue-scroll>
            ...
            <div class="footer-item text-right m-t">
                <a-button type="primary" size="large" class="middle-btn" @click="addVersionTask">save</a-button>
            </div>
        </a-modal>
        <a-modal
                destroyOnClose
        ...
        methods: {
                ...
                switch (actionKey) {
                    case 'delete':
                        this.$confirm({
                            ...
                            content: `After deleting the version, the version field of the published content will be cleared. Are you sure to delete?`,
                            okText: 'Sure',
                            okType: 'danger',
            ...
            addVersionTask() {
                addVersionTask({
                    ...
                    notice({title: `successfully added ${res.data.successTotal} Item published to version`}, 'notice', 'success');
