        ...
        <a-spin :spinning="loading">
            ...
            <div class="search-content">
                <a-form
                    ...
                    >
                        <a-input
                                placeholder='Search for tasks within a project'
                                v-decorator="[
                                            'title',
                                            ]"
                        >
                    ...
                    >
                        <a-select
                                ...
                                optionFilterProp="children"
                        >
                            <a-select-option :key="-1">all</a-select-option>
                    ...
                    >
                        <a-select
                                ...
                                optionFilterProp="children"
                        >
                            <a-select-option :key="0">ordinary</a-select-option>
                            <a-select-option :key="1">urgent</a-select-option>
                            <a-select-option :key="2">very urgent</a-select-option>
                        </a-select>
                    </a-form-item>
                    <a-form-item
                ...
                <div class="footer m-t-md">
                    <a-button class="m-r" type="primary" size="large" @click="handleSubmit">search</a-button>
                    <a-button size="large" @click="resetForm">reset</a-button>
                </div>
            </div>
        </a-spin>
    </div>
