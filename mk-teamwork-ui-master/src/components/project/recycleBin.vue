                        ...
                        <a-list>
                            ...
                            <a-list-item :key="index" v-for="(item, index) in list">
                                ...
                                <a class="muted" slot="actions" @click="recoveryTask(item,index)">
                                    <a-tooltip title="restore content">
                                        <a-icon type="undo"/>
                                    </a-tooltip>
                                </a>
                                <a class="muted" slot="actions" @click="deleteItem(item,index)">
                                    <a-tooltip title="Remove completely">
                                        <a-icon type="delete"/>
                                    </a-tooltip>
                                </a>
                            </a-list-item>
        ...
        methods: {
            ...
            recoveryTask(item, index) {
                ...
                switch (this.tabKey) {
                    case '1':
                        this.$confirm({
                            title: 'Are you sure to restore content?',
                            content: `Can be viewed in the task list after recovery`,
                            okText: 'restore content',
                            okType: 'primary',
                    ...
                    case '2':
                        this.$confirm({
                            title: 'Are you sure you want to restore the file?',
                            content: `Viewable in My Files after recovery`,
                            okText: 'recover files',
                            okType: 'primary',
                            cancelText: 'Think again',
                            onOk() {
            ...
            deleteItem(item, index) {
                ...
                switch (this.tabKey) {
                    ...
                    case '2':
                        this.$confirm({
                            title: 'Are you sure to delete this file completely?',
                            content: `After the file is completely deleted, the related associated resources will become invalid.`,
                            okText: 'Remove completely',
                            okType: 'danger',
                            cancelText: 'Think again',
                            onOk() {
