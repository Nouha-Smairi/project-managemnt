<template>
    <div class="member-menu">
        <a-spin :spinning="listLoading || doListLoading">
            ...
            <div class="member-list">
                <vue-scroll>
                    <div class="list-group" v-show="!keyword">
                        <span class="title muted">Executor</span>
                        <div class="member-list-item ant-list-item" v-if="!doList.length && !doListLoading" @click="assignTask(null)">
                            <div class="ant-list-item-meta">
                                ...
                                <div class="ant-list-item-meta-content">
                                    <h4 class="ant-list-item-meta-title"><span>pending claim</span></h4>
                                </div>
                            </div>
                    ...
                    <div class="list-group">
                        ...
                        <a-list
                                ...
                                itemLayout="horizontal"
                                :dataSource="list"
                                :locale="{emptyText: (keyword && keyword.length > 1) ? 'The member is not in the task member list, you can invite him in' : ''}"
                        >
            ...
            <div class="footer">
                <a-button type="primary" size="large" block @click="inviteProjectMember">invite new members</a-button>
            </div>
        </a-spin>
    </div>
</template>
