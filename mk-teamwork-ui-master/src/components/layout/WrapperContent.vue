    ...
    <div>
        <div class="page-header" v-if="showHeader">
            <div class="breadcrumb" v-if="breadCrumbInfo.length > 0 && breadCrumb">
                <a-breadcrumb>
                    <a-breadcrumb-item>
                        <router-link to="/home">front page</router-link>
                    </a-breadcrumb-item>
...
<script>
    ...
    export default {
        ...
        mounted() {
            //User permission resource detection
            function TraversalObject(obj, value) {
                for (let a in obj) {
                    if (typeof (obj[a]) === "object") {
                        TraversalObject(obj[a], value); //recursive traversal
                    }
                    else {
            ...
            this.$nextTick(function () {
                //Hide the content area of all parent pages on mount
