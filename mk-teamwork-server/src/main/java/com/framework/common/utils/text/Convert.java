package com.framework.common.utils.text;
...
public class Convert
{
     ...
     * 1. Byte arrays and ByteBuffers will be converted to arrays corresponding to strings 2. Object arrays will call the Arrays.toString method
     *
     * @param obj object
     * @return string
     */
    ...
    public static String toSBC(String input, Set<Character> notConvertSet)
    {
        ...
        for (int i = 0; i < c.length; i++)
        {
            ...
            {
            	// Skip characters not to be replaced
                continue;
            }
