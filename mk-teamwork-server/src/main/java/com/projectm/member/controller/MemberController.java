...
public class MemberController  extends BaseController {
    ...
    public AjaxResult indexEditPersonal(@RequestParam Map<String,Object> mmap) {
        ...
        return AjaxResult.success("Basic information updated successfully",memberService.updateMemberAccountAndMember(memberAccount,member));
    }
    ...
    public AjaxResult taskMemberInviteMemberBatch(@RequestParam Map<String,Object> mmap) {
        ...
        if(StringUtils.isEmpty(memberCodes) || StringUtils.isEmpty(taskCode)){
            return AjaxResult.warn("data exception！");
        }
    ...
    public AjaxResult accountEdit(@RequestParam Map<String,Object> mmap) {
        ...
        if(!CommUtils.isChinaPhoneLegal(mobile)){
            //return AjaxResult.warn("Wrong phone number！");
        }
    ...
    /**
     *front page > member >vilson >task arrangement
     * @param mmap
     * @return
     */
    ...
    public AjaxResult accountRead(@RequestParam Map<String,Object> mmap) {
        ...
        if(status == 0){
            memberAccountMap.put("statusText","disabled");
        }else if(status == 1){
            memberAccountMap.put("statusText","Using");
        }
        String depName = "";
        if(null != depCodeArr) {
    ...
    public AjaxResult accountIndex(@RequestParam Map<String,Object> mmap) {
        ...
        if(!CollectionUtils.isEmpty(records)){
            ...
            for(Map map:records){
                ...
                if(status == 0){
                    map.put("statusText","disabled");
                }else if(status == 1){
                    map.put("statusText","Using");
                }
                String depName = "";
                if(null != depCodeArr) {
                    for (String deptCode : depCodeArr) {
    ...
    /**
     * Project Management My Projects Invite New Members Fuzzy Query
     * @param mmap
     * @return
     */
    ...
    /**
     * Project management My project Invite new members page initialization
     * @param mmap
     * @return
     */
    ...
    public AjaxResult _listForInvite(@RequestParam Map<String,Object> mmap) {
        ...
        if(StringUtils.isEmpty(projectCode)){
            throw new CustomException("Please select an item first");
        }
    ...
    /**
     * Project Management My Project Project Settings Task Flow Rule Creation Page Initialization
     * @param mmap
     * @return
     */
