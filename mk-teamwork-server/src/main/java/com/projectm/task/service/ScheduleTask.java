...
public class ScheduleTask {
    ...
    /**
     * Completion status of computing tasks performed every day
     */
    @Scheduled(cron = "0 1 0 * * ?")
    public void taskSettlement() {
   log.info("taskSettlement exectuted");
    	taskCountInfo(null);
    }
            ...
            proCodeList.forEach(pro -> {
                for (int i = -9; i <= -1; i++) {
                    ...
                    if (one != null) {
                        ...
                        log.info("Update project completion quantity：{}", update);
                    } else {
                        ...
                        log.info("The number of new projects completed：{}", save);
                    }
                }
