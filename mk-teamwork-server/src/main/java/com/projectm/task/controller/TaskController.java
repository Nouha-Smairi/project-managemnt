...
public class TaskController  extends BaseController {
    ...
    /**
     *
     * Project management My project Open project Task list Open task details Set task end time, notes, priority
     * @param mmap
     * @return
     */
    ...
    public AjaxResult taskEdit(@RequestParam Map<String,Object> mmap)   {
        ...
        if(MapUtils.isNotEmpty(taskMap)){
            ...
            if(StringUtils.isNotEmpty(end_time)){
                ...
                projectLog.setRemark("The update deadline is "+end_time);
            ...
            if(-1!=pri){
                ...
                projectLog.setRemark("The update task priority is "+deRe);
...
*/
    ...
    /**
     *
     * Project Management My Projects Project Open Task List Open Task Details Add Comment
     * @param mmap
     * @return
     */
    ...
    public AjaxResult taskCreateComment(@RequestParam Map<String,Object> mmap)  throws Exception {
        ...
        projectLog.setIs_comment(1);//whether to comment, 0: no
    ...
    /**
     * Project Management My Projects Open Projects Task List Open Task Details Edit Hours
     * @param mmap
     * @return
     */
    ...
    /**
     * Project Management My Projects Project Open Task List Open Task Details Add Work
     * @param mmap
     * @return
     */
    ...
    /** undone
     * Project Management My Projects Open Project Task List Open Task Details Add Subtask
     * @param mmap
     * @return
     */
    ...
    public AjaxResult taskSave(@RequestParam Map<String,Object> mmap)  throws Exception {
        ...
        if(StringUtils.isEmpty(name)){
            return AjaxResult.warn("Please fill in the task title");
        }
        Task  task = new Task();
    ...
    /**
     * Project Management My Project Open Project Task List Open Task Details New Tab Save
     * @param mmap
     * @return
     */
    ...
    /**
     * Project Management My Projects Open Projects Task List Open Task Details Edit Tags Save
     * @param mmap
     * @return
     */
    ...
    public AjaxResult taskTagSave(@RequestParam Map<String,Object> mmap)  throws Exception
    {
        ...
        if(!MapUtils.isEmpty(taskTagMap)){
            return AjaxResult.warn("The label already exists");
        }
        TaskTag taskTag = new TaskTag();
    ...
    /**
     * Project Management My Projects Project Open Task List Open Task Details Add Tagging Initialize
     * @param mmap
     * @return
     */
    ...
    /**
     * Project Management My Projects Project Open Task List Open Task Details
     * @param mmap
     * @return
     */
    ...
    /**
     * Project Management My Projects Project Open Task List
     * @param mmap
     * @return
     */
    ...
    /**
     * Project Management My Projects Project Settings Task Flow Create RulesOpen
     * @param mmap
     * @return
     */
    ...
    /**
     * Project Management My Project Project Settings Task Flow Delete Task
     * @param mmap
     * @return
     */
...
//    }
    ...
    /**
     * Project Management My Project Project Settings Task Flow Edit Task
     * @param mmap
     * @return
     */
    ...
    /**
     * Project Management My Project Project Settings Task Flow Create Rules and Save
     * @param mmap
     * @return
     */
    ...
    public AjaxResult like(@RequestParam Map<String,Object> mmap)  throws Exception {
        ...
        if(MapUtils.isEmpty(taskMap)){
            return AjaxResult.warn("This mission has expired!");
        }
        Map taskMapNoDel = taskService.getTaskByCodeNoDel(code);
        if(MapUtils.isEmpty(taskMapNoDel)){
            return AjaxResult.warn("This task cannot be liked in the recycle bin!");
        }
    ...
    public AjaxResult star(@RequestParam Map<String,Object> mmap)  throws Exception {
        ...
        Map taskMapNoDel = taskService.getTaskByCodeNoDel(code);
        if(MapUtils.isEmpty(taskMapNoDel)){
            return AjaxResult.warn("This task cannot be collected in the recycle bin!");
        }
