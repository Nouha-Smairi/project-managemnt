...
public class AuthorityControoler extends BaseController {
    ...
    /**
     * System Settings/Member Management/Access Authorization/Set Default
     * @param mmap
     * @return
     */
    ...
    public AjaxResult authApply(@RequestParam Map<String,Object> mmap) {
        ...
        if("save".equals(action)){
            ...
            return AjaxResult.success("Node authorization updated successfully!",result);
    ...
    /**
     * System Settings/Member Management/Access Authorization/Delete
     * @param mmap
     * @return
     */
    ...
    /**
     * System Settings/Member Management/Access Authorization
     * @param mmap
     * @return
     */
    ...
    /**
     * System Settings/Member Management/Access Authorization Edit and Save
     * @param mmap
     * @return
     */
    ...
    /**
     *System Settings/Member Management/Access Authorization Add and Save
     * @param mmap
     * @return
     */
    ...
    /**
     * System Settings System Management Menu Edit
     * @param menuEdit
     * @return
     */
    ...
    public AjaxResult menuDel(ProjectMenu menuEdit) {
        ...
        return AjaxResult.success("Successfully modified", projectMenuService.updateById(menuEdit));
    }

    /**
     * System Settings System Administration Menu Enable
     * @param mmap
     * @return
     */
    ...
    /**
     * System Settings System Administration Menu Disabled
     * @param mmap
     * @return
     */
    ...
    /**
     * System Settings System Administration Menu Routing
     * @param mmap
     * @return
     */
    ...
    /**
     * System Settings System Management Menu Routing Add Menu Node Initialization
     * @param mmap
     * @return
     */
    ...
    {
        return AjaxResult.success("Invalid node list succeeded！");
    }
    ...
    /**
     * System Settings System Administration Menu Routing Add Menu Save
     * @param mmap
     * @return
     */
    ...
    public AjaxResult menuMenuAdd(@RequestParam Map<String,Object> mmap)  throws Exception
    {
        ...
        if(pm.getIsinner() == 0){pm.setInnerText("navigation");}else if(pm.getIsinner() == 1){ pm.setInnerText("inner page");}
        if(pm.getStatus() == 0){pm.setStatusText("disabled");}else if(pm.getStatus() == 1){ pm.setStatusText("Using");}
