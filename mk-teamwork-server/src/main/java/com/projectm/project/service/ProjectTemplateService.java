...
public class ProjectTemplateService extends ServiceImpl<ProjectTemplateMapper, ProjectTemplate>{
    ...
    //Obtain template list according to organizationCode
    ...
    //Add project templates and template tasks
    ...
    //Delete templates and template tasks
    @Transactional
    ...
    //Get projectTemplete according to code
